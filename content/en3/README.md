# Inglés 3 — `en3` (scaffold)

Carpeta preparada para el **nivel 3 de inglés**. Todavía **sin contenido**: aparece
como **"Próximamente"** en la landing hasta que se agregue el primer `unit-*.json`.

## Cómo activarlo

1. Dejá `unit-N.json` acá con `"course": "en3"` y átomos id `en3.uM.KIND.NNN`.
